export const text = {
    hackScreen: {
        ...
        passwords: ['abstract', 'achilles', 'affinity', 'affluent', 'ambition', 'approach', 'argument', 'aviation', 'autonomy', 'augustus', 'aurelian', 'aurelius',
        'baseball', 'bakesale', 'ballista', 
        'campaign', 'commodus', 'complete', 'compound', 'computer', 'congress', 'consider', 'constant', 'consumer', 'calculus', 'contract', 'caesarea',
        'diameter', 'diadochi', 'diabolic', 'director', 'disclose', 'discount', 'discreet', 'document', 'database', 'denarius',
        'emphasis', 'emphatic', 'emulator', 'explicit', 'electron', 'electric', 'election', 'external', 'explorer',
        ...
        'magazine', 'mainline', 'merchant', 'minister', 'mystical', 'mythical',
        ...
        'tendency', 'terminal', 'tokugawa', 'tolerant', 'traction', 'traianus', 'tyrannis', 'unlawful', 
        'vertical', 'validate',
        'yakiniku', 'yakitori', 'yakisoba'],
        gibberish_char: [
            "!","@","#","$","%","^","&","*","(",")","{","}","_","+","=","|",";","<",">","?","/",
            "1","2","3","4","5","6","7","8","9","0","~","[","]",",",".",":","-",
