export const text = {
    hackScreen: {
        ...
        passwords: ['abstract', 'achilles', 'affinity', 'affluent', 'ambition', 'approach', 'argument', 'argentum', 'arrogant', 'augustus', 'aurelian', 'aurelius',
        'baseball', 'bakesale', 'ballista', 
        'campaign', 'commodus', 'complete', 'compound', 'computer', 'congress', 'consider', 'constant', 'consumer', 'contempt', 'contract', 'caesarea',
        'diameter', 'diadochi', 'diabolic', 'director', 'disclose', 'discount', 'discreet', 'document', 'database',
        'emphasis', 'emphatic', 'emulator', 'encroach', 'explicit', 'electron', 'electric', 'election', 'external', 'explorer',
        'football', 'firmware', 'fighting', 'frontend',
        'gradient', 'graduate', 'galactic', 'granular',
        'headline', 'hercules', 'hokkaido', 'hardware', 'holistic',
        'innocent', 'instinct', 'interact', 'infinity', 'lighting',
        'magazine', 'mainline', 'merchant', 'minister', 'minstrel', 'milkyway', 'mystical', 'mythical',
        'obsolete', 'obstacle', 'odysseus', 'original', 'orthodox', 
        'personal', 'pleasant', 'pompeius', 'poseidon', 'precinct', 'quantity', 'platonic',
        'railroad', 'referral', 'referree', 'response', 'reproach', 
        'sentence', 'separate', 'shinjuku', 'shingeki', 'socrates', 'software', 'solitude', 'stunning', 'sukiyaki', 
        'tendency', 'terminal', 'tokugawa', 'tolerant', 'traction', 'traianus', 'tyrannis', 'unlawful', 'vertical',
        'yakiniku', 'yakitori',],
        gibberish_char: [
            "!","@","#","$","%","^","&","*","(",")","{","}","_","+","=","|",";","<",">","?","/",
            "1","2","3","4","5","6","7","8","9","0","~","[","]",",",".",":","-",
            "f","g","h","i","j","k","v","w","x","y","z"
        ],
        brackets: [
            ["(",")"], ["[","]"], ["{","}"], ["<",">"]
        ]
